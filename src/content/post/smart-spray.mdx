...
title: "Smart Spray"
excerpt: No more burning grass! GR96's Smart Spray features adjusts spray rate according to vehicle speed, and stops spraying when you stop.
image: ~/assets/images/gallery-4.jpg
category: Feature Highlight
tags:
  - GR96
metadata:
  canonical: https://zeroturfmachines.com/posts/auto-spray
---
...
//...
{subtitle && <p class="text-xl text-muted dark:text-zinc-400" set:html={subtitle} />}
//...
```
